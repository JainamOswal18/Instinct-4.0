    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.header}>
          ...
          {/* Role badge — uses role from User interface, not planType */}
          <View style={styles.planBadge}>
            <Text style={styles.planText}>
              {(user?.role ?? 'CITIZEN')} PLAN
            </Text>
          </View>
        </View>
        ...
        <Text style={styles.footer}>EaaS Nexus • Energy as a Service</Text>
...
const styles = StyleSheet.create({
  ...
  name: { fontSize: typography.h3, fontWeight: '700', color: colors.textPrimary, marginBottom: 4 },
  email: { fontSize: typography.small, color: colors.textSecondary, marginBottom: spacing.md },
  planBadge: {
    backgroundColor: colors.primaryLight, paddingHorizontal: spacing.md,
    paddingVertical: spacing.xs, borderRadius: borderRadius.sm,
  },
  planText: { fontSize: typography.tiny, fontWeight: '700', color: colors.primary, letterSpacing: 0.5 },
  ...
  menuIcon: {
    width: 36, height: 36, borderRadius: borderRadius.sm, backgroundColor: colors.surface,
    justifyContent: 'center', alignItems: 'center', marginRight: spacing.sm,
  },
  menuIconText: { fontSize: 18 },
  menuLabel: { fontSize: typography.body, color: colors.textPrimary },
  menuArrow: { fontSize: 18, color: colors.textTertiary },

  infoItem: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: spacing.sm },
  infoLabel: { fontSize: typography.small, color: colors.textSecondary },
  infoValue: { fontSize: typography.small, color: colors.textPrimary, fontWeight: '600' },

  logoutButton: {
    backgroundColor: colors.surface, marginHorizontal: spacing.md,
    marginVertical: spacing.lg, padding: spacing.md, borderRadius: borderRadius.md,
    borderWidth: 1, borderColor: colors.error, alignItems: 'center',
  },
  logoutText: { fontSize: typography.body, fontWeight: '600', color: colors.error },

  footer: { fontSize: typography.tiny, color: colors.textTertiary, textAlign: 'center', paddingBottom: spacing.xl },
});